...
// src/harness/** may import @singula-ai/*. Everything else stays
...
if (violations.length) {
  console.error('adapter boundary violated — @singula-ai/* imports outside src/harness/:')
...
console.log('adapter boundary OK (only src/harness imports @singula-ai/*)')
