 ...
 * overrode this app's default banner palette. alego-tui owns `~/.alego-tui`
...
export const APP_DIR_NAME = '.alego-tui'

/** Absolute path of the app data directory; `ALEGO_TUI_HOME` overrides it. */
export const appHome = (): string => process.env.ALEGO_TUI_HOME?.trim() || join(homedir(), APP_DIR_NAME)
