import { Box, type ScrollBoxHandle, stringWidth, Text } from '@alego-tui/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (ALEGO_TUI_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (ALEGO_TUI_DEV_CREDITS), lowest priority,
